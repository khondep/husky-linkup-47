...
import { Edit2, GraduationCap, Briefcase, MapPin, Settings } from 'lucide-react';
...
const userData = {
  ...
  location: 'Boston, MA',
  education: 'Northeastern University, BS Computer Science',
  graduationYear: '2023',
  occupation: 'UX Design Intern',
  ...
  return (
    <div className="flex flex-col min-h-screen bg-husky-light">
      <header className="sticky top-0 z-10 flex items-center justify-between bg-white/80 backdrop-blur-md px-6 py-4 border-b border-husky-gray-light">
        <h1 className="text-2xl font-semibold text-husky-black">Profile</h1>
        <Button 
          variant="ghost" 
